...
texts = [
    ...
    "I can't shake off this feeling of emptiness.",
    "Spending time with loved ones brings so much joy.",
    "I'm hopeless. There's no way out of this darkness.",
    "Every day is a new opportunity for growth and happiness.",
    "I can't bear the burden anymore. It's too heavy.",
    "I feel so loved and supported by my friends and family.",
    "I want to disappear. The world would be better off without me.",
    "Nature has a way of healing the soul. Enjoying a peaceful walk.",
    "I'm at the lowest point in my life. There's no way out.",
    "Grateful for the little things that bring happiness.",
    "I can't find any reasons to keep going. It's all meaningless.",
    "Today is a good day. Feeling positive and motivated!",
    "I'm drowning in despair. There's no escape.",
    "I have so much to live for. Excited about the future!",
    "The pain is unbearable. I just want it to end.",
    "Finding solace in music. It lifts my spirits.",
    "I'm contemplating ending it all. I can't go on like this.",
    "Cherishing the moments of laughter and joy with loved ones.",
    "I feel like a burden to everyone around me. They'd be better off without me.",
    "The world is a beautiful place. Grateful for its wonders.",
    "I can't handle the darkness anymore. It's suffocating.",
    "Celebrating small victories in life. Every step counts.",
    "I'm consumed by thoughts of self-harm. It's overwhelming.",
    "Reaching out for support. It's okay to ask for help.",
    "I'm surrounded by negativity. It's dragging me down.",
    "Dreaming big and working towards my goals. Anything is possible!",
    "I'm exhausted. Living feels like an endless battle.",
    "The love and kindness of others give me strength to carry on.",
    "I can't see a way out. The pain is all-consuming.",
    "Gratitude fills my heart. Appreciating the beauty in everyday moments.",
    "I can't fight the darkness anymore. It's taking over.",
    "Enjoying the simple pleasures in life. Grateful for what I have.",
    "I'm at the edge. The void is calling me.",
    "Surrounding myself with positivity and uplifting energy.",
    "I'm lost in a sea of despair. There's no way back.",
    "Finding joy in helping others. It brings purpose to my life.",
    "I'm trapped in a never-ending cycle of pain. It's suffocating me.",
    "Embracing self-care and self-love. Nurturing my well-being.",
    "I'm consumed by thoughts of self-destruction. It's consuming me.",
    "Seeking comfort in the beauty of art. It touches my soul.",
    "I'm shattered. There's nothing left to hold on to.",
    "Finding strength in vulnerability. Opening up to healing.",
    "I'm on the verge of giving up. The world feels cold and dark.",
]
